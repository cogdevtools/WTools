...
classdef WTConfig < matlab.mixin.Copyable & matlab.mixin.SetGet
    ...
    methods(Access=private)
        ...
        function success = load(o) 
            ...
            if ~o.Basic.exist()
                wtLog.err('An essential project configuration file is missing: ''%s'' ', o.Basic.getFileName());
                return
            end
            if ~o.Basic.load()
                wtLog.err('Failed to load configuration file: ''%s'' ', o.Basic.getFileName());
                return
            end
