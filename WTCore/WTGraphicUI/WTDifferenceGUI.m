        ...
        function success = defineDifferenceParams(differencePrms, conditionsGrandPrms, logFlag, evokFlag)
            ...
            try
                ...
                cbPair = [ ...
                    ...
                    'cnd1 = ud.Value.cnd1;' ...
                    'cnd2 = ud.Value.cnd2;' ...
                    'if ~isempty(cnd1) && ~isempty(cnd2) && ~strcmp(cnd1{1}, cnd2{1}),' ...
                    '  if sum(ismember(conditionsDiff,strcat(cnd1{1},''-'',cnd2{1}))) == 0' ...
                    '    conditionsDiff = cat(2, conditionsDiff, strcat(cnd1{1},''-'',cnd2{1}));' ...
